...
To use these stylesheets, rename the files and omega_pat with the name of your theme.
...
omega_pat-alpha-default-narrow.css  
...
omega_pat-alpha-default-normal.css
...
omega_pat-alpha-default-wide.css
